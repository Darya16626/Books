...
# installed.
TCL_PREFIX='f:/WUDownloadCache/Работа/Курсовая2/BookHaven/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='f:/WUDownloadCache/Работа/Курсовая2/BookHaven/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='f:/WUDownloadCache/Работа/Курсовая2/BookHaven/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-If:/WUDownloadCache/Работа/Курсовая2/BookHaven/.conda\Library\include'
...
TCL_PACKAGE_PATH='f:/WUDownloadCache/Работа/Курсовая2/BookHaven/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lf:/WUDownloadCache/Работа/Курсовая2/BookHaven/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='f:/WUDownloadCache/Работа/Курсовая2/BookHaven/.conda\Library\lib\tclstub86.lib'
